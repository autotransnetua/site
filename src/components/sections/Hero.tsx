...
const Hero = () => {
	return (
		<Section className='relative bg-slate-900 text-white overflow-hidden min-h-240 flex flex-col justify-center'>
			...
			<Container className='relative z-10 h-full flex flex-col justify-center'>
				<div className='max-w-3xl flex flex-col gap-y-8 h-full justify-center'>
					...
					<div className='mt-8 flex flex-wrap items-center gap-6 md:gap-8 font-medium text-white/80'>
