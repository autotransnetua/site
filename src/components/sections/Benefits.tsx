		...
		<Section className='bg-white py-20 lg:py-30'>
			<Container className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6'>
				{items.map(el => (
					<ul
						key={el.description}
						className='w-full md:w-75 2xl:w-95 flex flex-col items-start p-4 xl:p-6 rounded-xl hover:bg-background hover:shadow-lg hover:scale-105 transition-all mx-auto'
					>
						...
						<li className='text-lg xl:text-xl text-justify'>{el.description}</li>
					</ul>
				))}
			</Container>
		</Section>
